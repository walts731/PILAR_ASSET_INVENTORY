...
<div class="main">
  ...
  <div class="tab-content" id="inventoryTabsContent">
    ...
    <div class="tab-pane fade show active" id="assets" role="tabpanel">
      ...
      ?>
      <div class="row mb-4">
        <div class="col-md-3"><div class="card shadow-sm"><div class="card-body"><h5>Total</h5><h3><?= $total ?></h3></div></div></div>
        <div class="col-md-3"><div class="card shadow-sm"><div class="card-body"><h5>Available</h5><h3><?= $active ?></h3></div></div></div>
        <div class="col-md-3"><div class="card shadow-sm"><div class="card-body"><h5>Borrowed</h5><h3><?= $borrowed ?></h3></div></div></div>
        <div class="col-md-3"><div class="card shadow-sm"><div class="card-body"><h5>Red-Tagged</h5><h3><?= $red_tagged ?></h3></div></div></div>
      </div>
        ...
        <div class="card-body table-responsive">
          <table class="table table-hover align-middle">
            <thead class="table-light">
              <tr>
                <th>QR</th><th>Name</th><th>Category</th><th>Description</th><th>Qty</th><th>Unit</th><th>Status</th><th>Value</th><th>Acquired</th><th>Updated</th>
              </tr>
            </thead>
            <tbody>
              <?php
    ...
    <div class="tab-pane fade" id="consumables" role="tabpanel">
      ...
      ?>
      <div class="row mb-4">
        <div class="col-md-4"><div class="card shadow-sm"><div class="card-body"><h5>Total</h5><h3><?= $ctotal ?></h3></div></div></div>
        <div class="col-md-4"><div class="card shadow-sm"><div class="card-body"><h5>Available</h5><h3><?= $cactive ?></h3></div></div></div>
        <div class="col-md-4"><div class="card shadow-sm"><div class="card-body"><h5>Red-Tagged</h5><h3><?= $cred_tagged ?></h3></div></div></div>
      </div>
