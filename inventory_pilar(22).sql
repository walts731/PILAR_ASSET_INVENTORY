...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 24, 2025 at 08:56 AM
...
(1, 'Office Table – Wooden', 2, 'Office Table – Wooden', 1, 0, 'pcs', 'unserviceable', '2025-09-19', 4, 1, 1, '2025-09-22 10:04:13', 3500.00, '1.png', 'asset', '', '', '', 'MR-2025-00001', '', '', 17, NULL, 1, 'No. PS-5S-03-F02-01', '[]', 0, 1, 0, 0),
(3, 'Mouse', 2, 'Mouse', 1, 0, 'pcs', 'available', '2025-09-19', 4, 1, 0, '2025-09-22 10:04:13', 350.00, '3.png', 'asset', 'asset_3_1758293767.jpg', '', '', 'MR-2025-00003', '', '', 18, NULL, 2, 'No. PS-5S-03-F02-03', '[]', 0, 1, 0, 0),
(5, 'Printer Epson', 1, 'Printer Epson', 1, 0, 'pcs', 'unserviceable', '2025-09-19', 4, 1, 1, '2025-09-22 11:32:35', 4593.00, '5.png', 'asset', '', '', '', 'MR-2025-00005', '', '', 19, NULL, 3, 'No. PS-5S-03-F02-05', '[\"asset_5_1758540755_0.jpg\"]', 0, 1, 0, 0),
(6, 'Printer Epson', 1, 'Printer Epson', 1, 0, 'pcs', 'available', '2025-09-19', 4, 1, 0, '2025-09-22 10:04:13', 4593.00, '6.png', 'asset', '', '', '', 'MR-2025-00006', '', '', 19, NULL, 3, 'No. PS-5S-03-F02-06', '[]', 0, 1, 0, 0),
(15, 'Blue Chair', 2, 'Uratex', 3, 0, 'pcs', 'available', '2025-04-04', 4, NULL, 0, '2025-09-22 10:04:13', 30000.00, 'QR.png', 'asset', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '[]', 0, 1, 0, 0),
(16, 'eagle', 1, 'eagle', 1, 0, 'box', 'available', '2025-09-19', 49, NULL, 0, '2025-09-22 10:04:13', 345.00, '21.png', 'asset', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '[]', 0, 1, 0, 0),
(17, 'Van', 1, 'Van', 6, 0, 'unit', 'available', '2025-09-18', 49, NULL, 0, '2025-09-22 10:04:13', 49999.99, '54.png', 'asset', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '[]', 0, 1, 0, 0),
(19, 'Cellphone', 1, 'Cellphone', 1, 0, 'pcs', 'unserviceable', '2025-09-21', 4, 1, 1, '2025-09-22 10:04:13', 5678.00, '19.png', 'asset', '', '', '', 'MR-2025-00019', '', '', 25, NULL, 8, 'No. PS-5S-03-F02-19', '[]', 0, 1, 0, 0),
(20, 'Cellphone', 1, 'Cellphone', 1, 0, 'pcs', 'unserviceable', '2025-09-21', 4, 2, 1, '2025-09-22 10:04:13', 5678.00, '20.png', 'asset', '', '', '', 'MR-2025-00020', '', '', 25, NULL, 8, 'No. PS-5S-03-F02-20', '[]', 0, 1, 0, 0),
(21, 'Ballpen', NULL, 'Ballpen', 2, 2, 'box', 'available', '2025-09-21', 3, NULL, 0, '2025-09-22 10:04:13', 345.00, '', 'consumable', '', '', '', '', '', '', NULL, NULL, NULL, '', '[]', 0, 1, 0, 0),
(22, 'Ballpen', NULL, 'Ballpen', 2, 2, 'box', 'available', '2025-09-21', 3, NULL, 0, '2025-09-22 10:04:13', 234.01, '', 'consumable', '', '', '', '', '', '', NULL, NULL, NULL, '', '[]', 0, 1, 0, 0),
(23, 'Dell Unit', 1, 'Dell Unit', 1, 0, 'unit', 'unserviceable', '2025-09-21', 4, 1, 1, '2025-09-22 10:04:13', 99000.00, '23.png', 'asset', '', '', '', NULL, '', '', NULL, NULL, 9, NULL, '[]', 0, 1, 0, 0),
(24, 'Dell Unit', NULL, 'Dell Unit', 1, 0, 'unit', 'available', '2025-09-21', 4, NULL, 0, '2025-09-22 10:04:13', 99000.00, '24.png', 'asset', '', '', '', NULL, '', '', NULL, NULL, 9, NULL, '[]', 0, 1, 0, 0),
(27, 'Jetski', 1, 'Jetski', 1, 0, 'unit', 'unserviceable', '2025-09-21', 4, 2, 1, '2025-09-22 10:04:13', 96780.00, '27.png', 'asset', '', '', '', NULL, '', '', NULL, NULL, 12, NULL, '[]', 0, 1, 0, 0),
(28, 'Jetski', NULL, 'Jetski', 1, 0, 'unit', 'available', '2025-09-21', 4, NULL, 0, '2025-09-22 10:04:13', 96780.00, '28.png', 'asset', '', '', '', NULL, '', '', NULL, NULL, 12, NULL, '[]', 0, 1, 0, 0),
(29, 'HIlux', NULL, 'HIlux', 1, 0, 'roll', 'available', '2025-09-21', 4, NULL, 0, '2025-09-22 10:04:13', 1000000.00, '29.png', 'asset', '', '', '', NULL, '', '', NULL, NULL, 13, NULL, '[]', 0, 1, 0, 0),
(30, 'Car', NULL, 'Car', 1, 0, 'unit', 'unserviceable', '2025-09-21', 4, NULL, 1, '2025-09-22 10:04:13', 4500000.00, '30.png', 'asset', '', '', '', NULL, '', '', NULL, NULL, 14, NULL, '[]', 0, 1, 0, 0),
(31, 'Mio Soul i', 1, 'Mio Soul i', 1, 0, 'unit', 'available', '2025-09-21', 4, 2, 0, '2025-09-22 10:04:13', 75000.00, '31.png', 'asset', '', '', '', NULL, '', '', NULL, 44, 15, NULL, '[]', 0, 1, 0, 0),
(32, 'Honda', 1, 'Honda Click 125', 1, 0, 'unit', 'unserviceable', '0000-00-00', 7, 2, 1, '2025-09-22 10:04:13', 75000.00, '32.png', 'asset', '', '', '', '', '', '', NULL, 45, 16, 'No. PS-5S-03-F02-32', '[]', 0, 1, 0, 0),
(33, 'Hilux Van', 1, 'Hilux Van', 1, 0, 'unit', 'unserviceable', '2025-09-21', 4, 3, 1, '2025-09-22 10:13:37', 7600000.00, '33.png', 'asset', '', '', '', 'MR-2025-00033', '', '', NULL, 46, 17, 'No. PS-5S-03-F02-33', '[\"asset_33_1758536017_0.jpg\"]', 0, 1, 0, 0),
(34, 'Hilux van black', 2, 'Hilux van black', 1, 0, 'unit', 'unserviceable', '2025-09-22', 4, 8, 1, '2025-09-22 10:04:13', 2300000.00, '34.png', 'asset', '', '', 'EQP-001', 'MR-2025-00034', '', '', NULL, 47, 18, 'No. PS-5S-03-F02-34', '[]', 0, 1, 0, 0),
(35, 'Lenovo AMD Ryzen 7', NULL, 'Lenovo AMD Ryzen 7', 1, 0, 'unit', 'unserviceable', '2025-09-22', 4, NULL, 1, '2025-09-22 10:04:13', 75000.00, '35.png', 'asset', '', '', '', NULL, '', '', NULL, 49, 19, NULL, '[]', 0, 1, 0, 0),
(36, 'Lenovo AMD Ryzen 7', NULL, 'Lenovo AMD Ryzen 7', 1, 0, 'unit', 'available', '2025-09-22', 4, NULL, 0, '2025-09-22 10:04:13', 75000.00, '36.png', 'asset', '', '', '', NULL, '', '', NULL, 49, 19, NULL, '[]', 0, 1, 0, 0),
(40, 'Computer', 1, 'Computer', 1, 0, 'unit', 'unserviceable', '2025-09-22', 4, 2, 1, '2025-09-23 10:17:04', 36500.00, '40.png', 'asset', '', '', '', 'MR-2025-00040', '', '', 27, NULL, 21, 'No. PS-5S-03-F02-40', NULL, 0, 1, 0, 0),
(41, 'Computer', 1, 'Computer', 1, 0, 'unit', 'unserviceable', '2025-09-22', 4, 2, 0, '2025-09-23 10:17:39', 36500.00, '41.png', 'asset', '', '', '', 'MR-2025-00041', '', '', 27, NULL, 21, 'No. PS-5S-03-F02-41', NULL, 0, 1, 0, 0),
(42, 'ballpen', NULL, 'ballpen', 100, 100, 'pcs', 'available', '2025-09-23', 3, NULL, 0, '2025-09-23 03:42:36', 7.50, '', 'consumable', '', '', '', '', '', '', NULL, NULL, NULL, '', NULL, 0, 1, 0, 0),
(43, 'ballpen panda', NULL, 'ballpen panda', 20, 20, 'pcs', 'available', '2025-09-23', 3, NULL, 0, '2025-09-23 06:03:11', 7.00, '', 'consumable', '', '', '', '1', '', '', NULL, NULL, NULL, '', NULL, 0, 1, 0, 0);
...
(21, 17, 'Mark Jayson Namia', 'LOGOUT', 'Authentication', 'User logged out successfully', NULL, NULL, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/140.0.0.0 Safari/537.36', '2025-09-24 04:17:48'),
(22, NULL, 'Office_admin', 'LOGIN_FAILED', 'Authentication', 'Failed login attempt for username \'Office_admin\' - user not found', NULL, NULL, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/140.0.0.0 Safari/537.36', '2025-09-24 04:17:59'),
(23, 17, 'nami', 'LOGIN', 'Authentication', 'User \'nami\' logged in successfully (Role: admin)', NULL, NULL, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/140.0.0.0 Safari/537.36', '2025-09-24 04:18:04');
...
--
-- Stand-in structure for view `batch_summary`
-- (See below for the actual view)
--
...
,`batch_size` int(11)
,`expiry_date` date
,`quality_status` enum('pending','approved','rejected','quarantined')
,`created_at` timestamp
,`items_created` bigint(21)
,`items_available` decimal(22,0)
,`items_borrowed` decimal(22,0)
,`items_expired` decimal(22,0)
,`items_damaged` decimal(22,0)
);
...
--
-- Stand-in structure for view `expiring_batches`
-- (See below for the actual view)
--
CREATE TABLE `expiring_batches` (
`id` int(11)
,`batch_number` varchar(50)
,`batch_name` varchar(255)
,`asset_id` int(11)
...
(4, 4, 'Supply Office', 'Printer Epson', '', '', 0, 1, 1.00, 'pcs', '2025-09-19', 4593.00, 'Juan A. Dela Cruz', '0000-00-00', '0000-00-00', '2025-09-19 15:05:22', 5, 'No. PS-5S-03-F02-05'),
...
(14, 13, 'Supply Office', 'Computer', '', '', 0, 1, 1.00, 'unit', '2025-09-22', 36500.00, 'Maria Santos', '0000-00-00', '0000-00-00', '2025-09-22 13:04:03', 40, 'No. PS-5S-03-F02-40'),
(15, 14, 'Supply Office', 'Computer', '', '', 0, 1, 1.00, 'unit', '2025-09-22', 36500.00, 'Maria Santos', '0000-00-00', '0000-00-00', '2025-09-22 13:23:20', 41, 'No. PS-5S-03-F02-41');
...
--
-- Structure for view `batch_summary`
--
DROP TABLE IF EXISTS `batch_summary`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `batch_summary`  AS SELECT `b`.`id` AS `id`, `b`.`batch_number` AS `batch_number`, `b`.`batch_name` AS `batch_name`, `b`.`asset_id` AS `asset_id`, `a`.`asset_name` AS `asset_name`, `b`.`batch_size` AS `batch_size`, `b`.`expiry_date` AS `expiry_date`, `b`.`quality_status` AS `quality_status`, `b`.`created_at` AS `created_at`, count(`bi`.`id`) AS `items_created`, sum(case when `bi`.`status` = 'available' then 1 else 0 end) AS `items_available`, sum(case when `bi`.`status` = 'borrowed' then 1 else 0 end) AS `items_borrowed`, sum(case when `bi`.`status` = 'expired' then 1 else 0 end) AS `items_expired`, sum(case when `bi`.`status` = 'damaged' then 1 else 0 end) AS `items_damaged` FROM ((`batches` `b` left join `assets` `a` on(`b`.`asset_id` = `a`.`id`)) left join `batch_items` `bi` on(`b`.`id` = `bi`.`batch_id`)) GROUP BY `b`.`id` ;

-- --------------------------------------------------------

--
-- Structure for view `expiring_batches`
--
DROP TABLE IF EXISTS `expiring_batches`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `expiring_batches`  AS SELECT `b`.`id` AS `id`, `b`.`batch_number` AS `batch_number`, `b`.`batch_name` AS `batch_name`, `b`.`asset_id` AS `asset_id`, `a`.`asset_name` AS `asset_name`, `b`.`expiry_date` AS `expiry_date`, to_days(`b`.`expiry_date`) - to_days(curdate()) AS `days_until_expiry`, count(`bi`.`id`) AS `total_items`, sum(case when `bi`.`status` = 'available' then 1 else 0 end) AS `available_items` FROM ((`batches` `b` left join `assets` `a` on(`b`.`asset_id` = `a`.`id`)) left join `batch_items` `bi` on(`b`.`id` = `bi`.`batch_id`)) WHERE `b`.`expiry_date` is not null AND `b`.`expiry_date` > curdate() AND to_days(`b`.`expiry_date`) - to_days(curdate()) <= 90 GROUP BY `b`.`id` ORDER BY `b`.`expiry_date` ASC ;
...
--
ALTER TABLE `mr_details`
  MODIFY `mr_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
--
-- Constraints for table `batch_receipts`
--
ALTER TABLE `batch_receipts`
