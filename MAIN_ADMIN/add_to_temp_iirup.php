...
try {
    ...
    if ($insert_stmt->execute()) {
        echo json_encode(['success' => true, 'message' => 'Asset added to IIRUP list successfully']);
    } else {
    ...
    error_log("Error in add_to_temp_iirup.php: " . $e->getMessage());
