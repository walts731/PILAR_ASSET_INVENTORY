...
$stmt = $conn->prepare("
  SELECT br.id, a.asset_name, o.office_name, br.status, br.requested_at
    ...
    <div class="card shadow-sm">
      <form method="POST">
        <div class="card-header d-flex justify-content-between align-items-center">
          ...
          <button type="submit" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to cancel selected requests?')">
            ...
            <table id="requestsTable" class="table table-striped align-middle">
              ...
              <tbody>
                <?php while ($row = $result->fetch_assoc()): ?>
                  <tr>
                    <td>
                      <input type="checkbox" name="selected_requests[]" value="<?= $row['id'] ?>">
                    </td>
