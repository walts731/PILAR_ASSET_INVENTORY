                                ...
                                <form id="privacyForm">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="editor-container">
                                            ...
                                            <textarea id="privacy_content" name="content" style="display: none;">
    <?= $privacy_policy ? htmlspecialchars_decode($privacy_policy['content']) : '' ?>
</textarea>
                                ...
                                <form id="termsForm">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="editor-container">
                                            ...
                                            <textarea id="terms_content" name="content" style="display: none;"><?= $terms_of_service ? ($terms_of_service['content']) : '' ?></textarea>
                                        </div>
                                    </div>
...
if (privacyContent) {
    privacyQuill.clipboard.dangerouslyPasteHTML(privacyContent);
}


const termsContent = document.getElementById('terms_content').value;
if (termsContent) {
    termsQuill.clipboard.dangerouslyPasteHTML(termsContent);
}
