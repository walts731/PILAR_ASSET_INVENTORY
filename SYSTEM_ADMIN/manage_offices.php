...
// Fetch all offices with a count of assets
$offices = [];
$sql = "SELECT o.id, o.office_name, COUNT(a.id) AS asset_count
        FROM offices o
...
<body>
        ...
        <div class="container mt-4">
            <div class="card shadow">
                ...
                <div class="card-body">
                    ...
                    <!-- Offices Table -->
                    <table id="officesTable" class="table table-hover  align-middle">
                        ...
                        <tbody>
                            <?php foreach ($offices as $office): ?>
                                <tr>
                                    <td class="text-center"><?= htmlspecialchars($office['office_name']) ?></td>
                                    <td class="text-center"><?= $office['asset_count'] ?></td>
                                    <td class="text-center">
                                        ...
                                        <!-- Delete Button -->
                                        <?php if ($office['asset_count'] > 0): ?>
                                            <button class="btn btn-outline-danger btn-sm" disabled
                                                title="Cannot delete. Office has assets.">
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <form method="POST" action="office_delete.php">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="hidden" name="id" id="deleteOfficeId">
                    </div>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form method="POST" action="office_edit.php">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label class="form-label">Office Name</label>
                            <input type="text" class="form-control" name="office_name" id="editOfficeName" required>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.editBtn', function() {
                $('#editOfficeId').val($(this).data('id'));
                $('#editOfficeName').val($(this).data('name'));
            ...
            deleteModal.addEventListener('show.bs.modal', function(event) {
                ...
                document.getElementById('officeName').textContent = officeName;
            });
        });
    </script>
</body>
